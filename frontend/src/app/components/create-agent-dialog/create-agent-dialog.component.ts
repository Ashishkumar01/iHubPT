...
@Component({
  ...
  template: `
    <h2 mat-dialog-title>Create New Agent</h2>
        ...
        <div class="tools-section">
          ...
          <mat-selection-list formControlName="tools" class="tools-list">
            <div *ngFor="let tool of availableTools">
              <mat-list-option [value]="tool.name" [matTooltip]="tool.description" [matTooltipPosition]="'right'">
...
export class CreateAgentDialogComponent implements OnInit {
  ...
  constructor(
    ...
    this.form = this.fb.group({
      ...
      prompt: ['You are a helpful assistant.', [Validators.required]],
      hitl_enabled: [false],
      tools: [[], [Validators.required, Validators.minLength(1)]]
    });
  }
